    ...
    internal static class SettingSchemeLookup
    {
        internal static readonly Dictionary<SettingScheme, IPowerScheme> SettingSchemes
            = new Dictionary<SettingScheme, IPowerScheme>
            {
                ...
                { SettingScheme.Ultimate, new PowerScheme(new Guid("e9a42b02-d5df-448d-aa00-03f14749eb61"), true, ImageItem.Ultimate, false) },
                ...
                { SettingScheme.Extreme, new PowerScheme(new Guid("f384acfa-ed71-4607-bf8e-747d56402f0c"), false, ImageItem.Extreme) }
            };
