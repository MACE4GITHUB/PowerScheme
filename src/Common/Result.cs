...
public class Result
{
    ...
    /// </summary>
    /// <returns></returns>
    public static Result Ok() => new(true, null, LevelInfo.Silent);
    ...
    /// <param name="message"></param>
    /// <returns></returns>
    public static Result Info(string message) => new(true, message, LevelInfo.Info);

    /// <summary>
    /// Gets Silent Result. The default value of IsError = true.
    /// </summary>
    /// <returns></returns>
    public static Result Silent() => new(false, null, LevelInfo.Silent);
    ...
    /// <param name="message"></param>
    /// <returns></returns>
    public static Result Fail(string message) => new(false, message, LevelInfo.Error);
...
public class Result<T> : Result 
{
    ...
    /// <param name="data"></param>
    /// <returns></returns>
    public static Result<T> Ok<T>(T data) => new(true, null, LevelInfo.Silent, data);
    ...
    /// <param name="data"></param>
    /// <returns></returns>
    public static Result<T> Info<T>(string message, T data) => new(true, message, LevelInfo.Info, data);
    ...
    /// <param name="data"></param>
    /// <returns></returns>
    public static Result<T> Silent<T>(string message, T data) => new(false, message, LevelInfo.Silent, data);
    ...
    /// <param name="message"></param>
    /// <returns></returns>
    public static Result<T> Fail<T>(string message) => new(false, message, LevelInfo.Error, default);
}